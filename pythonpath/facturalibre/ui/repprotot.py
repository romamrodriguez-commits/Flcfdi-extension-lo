...
class Dlg(object):
    ...
    def __config(self):
        ...
        self.dialog.Title = 'Reporte de compras'
        self.dm.optFacturas.Label = 'Facturas de compra'
        self.dm.optProductos.Label = 'Producto comprado'
        self.dm.optProductos.Enabled = False

        #~ Consultamos la base de datos para asegurar que hay facturas para consultar
        data=self.db.select(('compras',),('id',))
        if not data:
